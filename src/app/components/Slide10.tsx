...
const blocks: ServiceBlock[] = [
    ...
    items: [
      <>
        ...
        <span className="mt-2 block text-white/70">
          Зөвшөөрлийн харилцааг журмаар зохицуулж байгааг хуулиар зохицуулж, салбарын 60 гаруй журмаар хүнд суртал тогтоож байгааг хална.
        </span>
      </>,
      <>ЗӨВШӨӨРӨЛД АВАХАД НЭХДЭГ 20-30 ШААРДЛАГЫГ 8-15 БОЛГОЖ БАГАСГАВ</>,
    ],
    metrics: [
  ...
  },
  {
    ...
    icon: Cloud,
    items: [
      <>ЦААСАН БИШ ЦАХИМ ЗӨВШӨӨРӨЛ</>,
      <>321 зөвшөөрлийг цаасаар биш цахимаар, цаг мөнгө хэмнэн авч эхлэв. AI-ашиглан 30 минутанд оноосон нэрээ сонгон авч, бүртгүүлж, тамгаа захиалан, дансаа нээлгэдэг боллоо.</>,
