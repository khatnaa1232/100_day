...
const principles: Principle[] = [
  {
    ...
    bullets: [
      { icon: Ban, render: () => <>Төр гэнэтийн шийдвэр гаргахгүй.</> },
      {
        icon: Clock3,
        render: (H) => (
          <>Бизнес эрхлэгчийн ашигт сөргөөр нөлөөлөх, зардал нэмэх хууль тогтоомжийн дагаж мөрдөж эхлэх хугацаа батлагдсанаас хойш {H('6 сараас доошгүй')}.</>
        ),
      },
    ],
  },
  {
    ...
    bullets: [
      {
        icon: Repeat,
        render: (H) => <>Төр бизнес эрхлэгчээс {H('1 мэдээллийг')} {H('1 удаа')} авна.</>,
      },
    ],
  },
  {
    title: 'ЭРСДЭЛЭЭС СЭРГИЙЛЭХ ХЯНАЛТ ШАЛГАЛТ ЭН ТЭРГҮҮНД',
    icon: Gauge,
    accent: '#fb923c',
    span: 1,
    bullets: [
  ...
  },
  {
    ...
    bullets: [
      {
        icon: LineChart,
        render: () => <>Төрийн зохицуулах бол бизнес, хөрөнгө оруулалт, шударга өрсөлдөөнд үзүүлэх нөлөөг заавал үнэлэн тооцно.</>,
      },
      {
        icon: Trash2,
        render: (H) => <>Хууль, шийдвэрт {H('жил тутам')} дүн шинжилгээ хийж, хязгаарласан, давхардсан, үр ашиггүйг нь цуцална.</>,
      },
    ],
  },
  {
    ...
    bullets: [
      {
        icon: Zap,
        render: (H) => <>Цаасан хүнд суртлын бус {H('цахим')}, төр иргэндээ очдог түргэн үйлчилгээ.</>,
      },
      {
        icon: Search,
        render: (H) => <>Хэн, хаана, хэзээ, юуны тулд ямар шийдвэр гаргах нь {H('ил нээлттэй')}.</>,
      },
    ],
  },
  {
    title: 'ТӨР ҮНЭ ТОГТООХГҮЙ',
    icon: Scale,
    accent: '#a78bfa',
    span: 1,
    bullets: [
      {
        icon: Scale,
        render: (H) => <>Үнэ тарифын зохицуулалттай бизнесийн жагсаалт, төрөөс олгосон татаас, үр нөлөөлөл, {H('үргэлжлэх хугацаа нээлттэй')} байна.</>,
      },
    ],
  },
  {
    title: 'ХҮН ТАНИХГҮЙ AI ХУДАЛДАН АВАГЧ',
    icon: Bot,
    accent: '#fb7185',
    span: 2,
    bullets: [
      {
        icon: ShieldCheck,
        render: (H) => <>Сонгон шалгаруулалт, хөрөнгө мөнгөний зарцуулалт, худалдан авалт {H('чөлөөт шударга өрсөлдөөн')} үндэслэнэ.</>,
      },
      {
        icon: EyeOff,
        render: (H) => <>Хэн нэг дарга биш, хэнийг ч танихгүй {H('AI')} худалдан авалтанд ашиглана.</>,
      },
    ],
  },
  {
    ...
    bullets: [
      {
        icon: Globe2,
        render: (H) => <>Гадаадын иргэн, компани Монгол Улсад {H('оршин суухгүйгээр')} цахимаар ажиллахыг хуульчлав.</>,
      },
    ],
  },
];
      ...
      <main className="relative z-10 flex h-full flex-col px-12 pb-10 pt-[42px]">
        <header className="max-w-[1320px] animate-[s8Header_.72s_cubic-bezier(.22,1,.36,1)_both]">
          ...
          <h1 className="mt-4 text-[42px] leading-[1.02] font-black tracking-[-0.04em] text-white">
            Улс төрийн эрх чөлөөний дархлаа:
          ...
          <p className="mt-2 max-w-[980px] text-[16px] leading-[1.3] font-normal italic text-white/56">
            Эдийн засгийн эрх чөлөөний тухай анхдагч хууль, 100 хуулийн нэмэлт, өөрчлөлт:
          </p>
        </header>
